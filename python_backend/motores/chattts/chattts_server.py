...
# Garante que python_backend (2 níveis acima: motores/chattts/chattts_server.py) está no path do
# Python, para os imports absolutos (tts.*, principal.*, motores.chattts.*) resolverem.
...
os.environ.setdefault("HANZITRACKER_MOTOR", "ChatTTS")

from principal import ConstantesModule

# Pesos: o ChatTTS os baixa do Hugging Face na primeira carga. Redireciona o cache do HF para a
...
from motores.chattts.ChatTtsService import ChatTtsService
from principal.ServidorTtsModule import iniciarServidorTts


# ----- Execução -----
# Entry do sidecar ChatTTS (motor de voz): o servidor HTTP do contrato vive em ServidorTtsModule;
# aqui só se injeta o serviço deste motor. Congelado por chattts_server.spec.
if __name__ == '__main__':
    iniciarServidorTts(ChatTtsService())
